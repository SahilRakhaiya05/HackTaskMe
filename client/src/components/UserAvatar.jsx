...
const DEFAULT_IMAGE = "/path/to/default-avatar.png"; // Replace with your default image path
    ...
    <>
      <div>
        <Menu as='div' className='relative inline-block text-left'>
          ...
          >
            <Menu.Items className='absolute right-0 mt-2 w-56 origin-top-right divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none'>
              <div className='p-4'>
                <Menu.Item>
                  {({ active }) => (
                    <button
                      onClick={() => setOpen(true)}
                      className={`flex items-center w-full px-2 py-2 text-base rounded-md group ${
